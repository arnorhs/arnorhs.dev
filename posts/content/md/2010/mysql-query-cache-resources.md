...
To follow up on [my post about Drupal's MySQL performance](https://arnorhs.dev/2010/05/27/drupal-and-slow-mysql-queries/), I wanted to share some resources I found during that journey. First, the MySQL documentation has some resources on the subject, which are fairly vanilla type of resources.
